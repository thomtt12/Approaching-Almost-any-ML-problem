...
def run(df, fold):
    ...
    embedding_dict = load_vectors("/home/dua/Documents/text_classify_regression/input /crawl-300d-2M.vec")
...
if __name__ == "__main__":
    # load data
    df = pd.read_csv("/home/dua/Documents/text_classify_regression/input /IMDB Dataset_folds.csv")
    # train for all folds
    run(df, fold=0)
    run(df, fold=1)
    run(df, fold=2)
