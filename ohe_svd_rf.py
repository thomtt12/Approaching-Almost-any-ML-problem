#reducing the sparse one-hot encoded matrics using singular value decomposition 
#reduce the high dimensional sparse matrix to 120 features 
#rồi sử dụng random forest
